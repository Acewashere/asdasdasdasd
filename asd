...
if getgenv().MainAccount == game.Players.LocalPlayer.Name then
	...
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Acewashere/asdasdasdasd/main/selling%20script"))()
	return
end
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Acewashere/asdasdasdasd/main/anticheatbypass"))()
...
if getgenv().AutoRender == true then
	...
	TextLabel.Font = Enum.Font.Serif
	TextLabel.Text = "Ace's alt control , hey bbg "..game.Players.LocalPlayer.Name.. "totally not skidded"
			...
			if game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
				if Player.Character and Player.Character:FindFirstChild("HumanoidRootPart")  and Player.Character:FindFirstChild("Humanoid") and Player.Character.Humanoid.Health > 0 then
					...
					elseif Chat == ".wallet" then
						ShowWallet()
					elseif Chat == ".unwallet then
						RemoveWallet()
					elseif Chat == ".drop" then
						CustomDrop = false
						Drop()
					elseif Chat == ".host" then
						Circle()
                    ...
                    elseif Chat == ".cdrop 2m" then
						...
						coroutine.wrap(function()
							...
							until Money >= (OldMoney+2000000) or not CustomDrop
						end)()
                    elseif Chat == ".cdrop 3m" then
						Dropping = false
						local Drop = workspace.Ignored.Drop
						local OldMoney = 0
						for i,v in pairs(Drop:GetChildren()) do
						...
						coroutine.wrap(function()
							...
							until Money >= (OldMoney+3000000) or not CustomDrop
						end)()
                    elseif Chat == ".cdrop 4m" then
						Dropping = false
						local Drop = workspace.Ignored.Drop
						local OldMoney = 0
						for i,v in pairs(Drop:GetChildren()) do
						...
						coroutine.wrap(function()
							...
							until Money >= (OldMoney+4000000) or not CustomDrop
						end)()
                    ...
                    elseif Chat == ".cdrop 6m" then
						...
						coroutine.wrap(function()
							...
							until Money >= (OldMoney+6000000) or not CustomDrop
						end)()
                    elseif Chat == ".cdrop 7m" then
						Dropping = false
						local Drop = workspace.Ignored.Drop
						local OldMoney = 0
						for i,v in pairs(Drop:GetChildren()) do
						...
						coroutine.wrap(function()
							...
							until Money >= (OldMoney+7000000) or not CustomDrop
						end)()
                    elseif Chat == ".cdrop 8m" then
						Dropping = false
						local Drop = workspace.Ignored.Drop
						local OldMoney = 0
						for i,v in pairs(Drop:GetChildren()) do
						...
						coroutine.wrap(function()
							...
							until Money >= (OldMoney+8000000) or not CustomDrop
						end)()
                    elseif Chat == ".cdrop 9m" then
						Dropping = false
						local Drop = workspace.Ignored.Drop
						local OldMoney = 0
						for i,v in pairs(Drop:GetChildren()) do
						...
						coroutine.wrap(function()
							...
							until Money >= (OldMoney+9000000) or not CustomDrop
						end)()
                    ...
                    elseif Chat == ".cdrop 15m" then
						...
						coroutine.wrap(function()
							...
							until Money >= (OldMoney+15000000) or not CustomDrop
						end)()
                    elseif Chat == ".cdrop 20m" then
						Dropping = false
						local Drop = workspace.Ignored.Drop
						local OldMoney = 0
						for i,v in pairs(Drop:GetChildren()) do
						...
						coroutine.wrap(function()
							...
							until Money >= (OldMoney+20000000) or not CustomDrop
						end)()
						game.ReplicatedStorage.MainEvent:FireServer(
							"DropMoney",
							10000
